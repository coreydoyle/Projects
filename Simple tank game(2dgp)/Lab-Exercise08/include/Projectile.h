...
public:
	...
	bool update(double t_dt, std::vector<sf::Sprite> & t_wallSprites, std::function<void(int)>& t_funcApplyDamage, sf::Sprite t_tankBase);
...
private:
	...
	sf::IntRect m_projectileRect { 299, 154, 24, 10 };
