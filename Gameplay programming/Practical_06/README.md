# README #
SFML Command Pattern StarterKit. Includes Command, ConcreteCommands, Undo and Redo Example. Built and tested on Windows and Linux.
...
* **STEP 7** Navigate to cloned project folder `sfml_command`
